...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // 3. FILMS
        $f1  = Film::create(['titreFil' => 'John Wick',                           'descFil' => 'Un ancien tueur a gages reprend du service.',                          'imgFil' => 'johnwick.jpg',       'dureFil' => 101, 'dateSortie' => '2014-10-24', 'idGenre' => $g1->idGenre]);
        $f2  = Film::create(['titreFil' => 'Avatar',                               'descFil' => 'Un marine infiltre une planete extraterrestre.',                        'imgFil' => 'avatar.jpg',         'dureFil' => 162, 'dateSortie' => '2009-12-16', 'idGenre' => $g2->idGenre]);
        $f3  = Film::create(['titreFil' => 'La Grande Vadrouille',                 'descFil' => 'Deux Francais aident des aviateurs anglais.',                           'imgFil' => 'vadrouille.jpg',     'dureFil' => 132, 'dateSortie' => '1966-12-08', 'idGenre' => $g3->idGenre]);
        $f4  = Film::create(['titreFil' => 'Titanic',                              'descFil' => 'Une romance tragique a bord du celebre paquebot.',                      'imgFil' => 'titanic.jpg',        'dureFil' => 195, 'dateSortie' => '1997-12-19', 'idGenre' => $g4->idGenre]);
        $f5  = Film::create(['titreFil' => 'Le Roi Lion',                          'descFil' => 'Un lionceau doit reprendre sa place de roi.',                           'imgFil' => 'roilion.jpg',        'dureFil' => 88,  'dateSortie' => '1994-06-15', 'idGenre' => $g5->idGenre]);
        $f6  = Film::create(['titreFil' => 'Harry Potter a l ecole des sorciers',  'descFil' => 'Un orphelin decouvre qu il est sorcier.',                               'imgFil' => 'harrypotter.jpg',    'dureFil' => 152, 'dateSortie' => '2001-11-14', 'idGenre' => $g6->idGenre]);
        $f7  = Film::create(['titreFil' => 'Joker',                                'descFil' => 'La descente aux enfers d un homme qui devient le Joker.',               'imgFil' => 'joker.jpg',          'dureFil' => 122, 'dateSortie' => '2019-10-04', 'idGenre' => $g7->idGenre]);
        $f8  = Film::create(['titreFil' => 'Oppenheimer',                          'descFil' => 'L histoire de la creation de la bombe atomique.',                       'imgFil' => 'oppenheimer.jpg',    'dureFil' => 180, 'dateSortie' => '2023-07-19', 'idGenre' => $g4->idGenre]);
        $f9  = Film::create(['titreFil' => 'Barbie',                               'descFil' => 'Barbie quitte Barbieland pour le monde reel.',                          'imgFil' => 'barbie.jpg',         'dureFil' => 114, 'dateSortie' => '2023-07-19', 'idGenre' => $g3->idGenre]);
        $f10 = Film::create(['titreFil' => 'Dune : Deuxieme Partie',               'descFil' => 'Paul Atreides mene une guerre sainte sur Arrakis.',                     'imgFil' => 'dune2.jpg',          'dureFil' => 166, 'dateSortie' => '2024-02-28', 'idGenre' => $g2->idGenre]);
        $f11 = Film::create(['titreFil' => 'Super Mario Bros. le film',            'descFil' => 'Mario traverse le Royaume Champignon.',                                 'imgFil' => 'mario.jpg',          'dureFil' => 92,  'dateSortie' => '2023-04-05', 'idGenre' => $g5->idGenre]);
        $f12 = Film::create(['titreFil' => 'Spider-Man : Across the Spider-Verse', 'descFil' => 'Miles Morales traverse le multivers.',                                  'imgFil' => 'spiderverse2.jpg',   'dureFil' => 140, 'dateSortie' => '2023-05-31', 'idGenre' => $g5->idGenre]);
        $f13 = Film::create(['titreFil' => 'Wonka',                                'descFil' => 'La jeunesse de Willy Wonka.',                                           'imgFil' => 'wonka.jpg',          'dureFil' => 116, 'dateSortie' => '2023-12-13', 'idGenre' => $g3->idGenre]);
        $f14 = Film::create(['titreFil' => 'Napoleon',                             'descFil' => 'L ascension de Napoleon Bonaparte.',                                    'imgFil' => 'napoleon.jpg',       'dureFil' => 158, 'dateSortie' => '2023-11-22', 'idGenre' => $g4->idGenre]);
        $f15 = Film::create(['titreFil' => 'Rebel Moon - Partie 1',                'descFil' => 'Une colonie menacee par un empire galactique.',                         'imgFil' => 'rebelmoon.jpg',      'dureFil' => 133, 'dateSortie' => '2023-12-22', 'idGenre' => $g2->idGenre]);
        $f16 = Film::create(['titreFil' => 'The Killer',                           'descFil' => 'Un tueur se retourne contre ses employeurs.',                           'imgFil' => 'thekiller.jpg',      'dureFil' => 118, 'dateSortie' => '2023-11-10', 'idGenre' => $g1->idGenre]);
        $f17 = Film::create(['titreFil' => 'Aquaman et le Royaume perdu',          'descFil' => 'Aquaman affronte Black Manta.',                                        'imgFil' => 'aquaman2.jpg',       'dureFil' => 124, 'dateSortie' => '2023-12-20', 'idGenre' => $g1->idGenre]);
        $f18 = Film::create(['titreFil' => 'Hunger Games : La Ballade',            'descFil' => 'Les origines de Coriolanus Snow.',                                      'imgFil' => 'hungergames.jpg',    'dureFil' => 157, 'dateSortie' => '2023-11-15', 'idGenre' => $g1->idGenre]);
        $f19 = Film::create(['titreFil' => 'Gran Turismo',                         'descFil' => 'Un joueur devient pilote de course.',                                   'imgFil' => 'granturismo.jpg',    'dureFil' => 134, 'dateSortie' => '2023-08-09', 'idGenre' => $g1->idGenre]);
        $f20 = Film::create(['titreFil' => 'Indiana Jones et le Cadran',           'descFil' => 'La derniere aventure d Indiana Jones.',                                 'imgFil' => 'indianajones5.jpg',  'dureFil' => 154, 'dateSortie' => '2023-06-28', 'idGenre' => $g1->idGenre]);
        $f21 = Film::create(['titreFil' => 'Mission : Impossible 7',               'descFil' => 'Ethan Hunt traque une arme terrifiante.',                               'imgFil' => 'mi7.jpg',            'dureFil' => 163, 'dateSortie' => '2023-07-12', 'idGenre' => $g1->idGenre]);
        $f22 = Film::create(['titreFil' => 'Le Garcon et le Heron',                'descFil' => 'Chef oeuvre Ghibli.',                                                   'imgFil' => 'boyheron.jpg',       'dureFil' => 124, 'dateSortie' => '2023-11-01', 'idGenre' => $g5->idGenre]);
        $f23 = Film::create(['titreFil' => 'Wish : Asha et la bonne etoile',       'descFil' => 'Asha invoque une force cosmique.',                                      'imgFil' => 'wish.jpg',           'dureFil' => 95,  'dateSortie' => '2023-11-29', 'idGenre' => $g5->idGenre]);
        $f24 = Film::create(['titreFil' => 'Superman',                             'descFil' => 'Une nouvelle ere pour le Man of Steel.',                                'imgFil' => 'supermanlegacy.jpg', 'dureFil' => 140, 'dateSortie' => '2025-07-11', 'idGenre' => $g1->idGenre]);
        $f25 = Film::create(['titreFil' => 'Un film Minecraft',                    'descFil' => 'Adaptation du celebre jeu video.',                                      'imgFil' => 'minecraft.jpg',      'dureFil' => 100, 'dateSortie' => '2025-04-02', 'idGenre' => $g5->idGenre]);
        $f26 = Film::create(['titreFil' => 'Mickey 17',                            'descFil' => 'Un homme jetable lors d une colonisation spatiale.',                    'imgFil' => 'mickey17.jpg',       'dureFil' => 139, 'dateSortie' => '2025-01-29', 'idGenre' => $g2->idGenre]);
        $f27 = Film::create(['titreFil' => 'Tron: Ares',                           'descFil' => 'Un programme s infiltre dans le monde reel.',                           'imgFil' => 'tronares.jpg',       'dureFil' => 130, 'dateSortie' => '2025-10-10', 'idGenre' => $g2->idGenre]);
        ...
        // 11. ROLES DES PERSONNES
        $rReal  = RolePersonne::create(['libRolePer' => 'Realisateur']);       // id 1
        $rActe  = RolePersonne::create(['libRolePer' => 'Acteur principal']);  // id 2
        $rActe2 = RolePersonne::create(['libRolePer' => 'Acteur secondaire']); // id 3
        $rProd  = RolePersonne::create(['libRolePer' => 'Producteur']);        // id 4
        $rSce   = RolePersonne::create(['libRolePer' => 'Scenariste']);        // id 5

        // 12. PERSONNES
        $pStahelski   = Personne::create(['nomPer' => 'Stahelski',   'prenomPer' => 'Chad',        'dateNaisPer' => '1968-09-20', 'bioPer' => 'Realisateur americain ex-cascadeur.',          'lieuNaisPer' => 'Kirkland, USA']);
        $pReeves      = Personne::create(['nomPer' => 'Reeves',      'prenomPer' => 'Keanu',       'dateNaisPer' => '1964-09-02', 'bioPer' => 'Acteur americano-canadien polyvalent.',         'lieuNaisPer' => 'Beyrouth, Liban']);
        $pKolstad     = Personne::create(['nomPer' => 'Kolstad',     'prenomPer' => 'Derek',       'dateNaisPer' => '1977-01-01', 'bioPer' => 'Scenariste americain auteur de John Wick.',     'lieuNaisPer' => 'USA']);
        $pCameron     = Personne::create(['nomPer' => 'Cameron',     'prenomPer' => 'James',       'dateNaisPer' => '1954-08-16', 'bioPer' => 'Realisateur et scenariste de blockbusters.',    'lieuNaisPer' => 'Kapuskasing, Canada']);
        ...
        $pOury        = Personne::create(['nomPer' => 'Oury',        'prenomPer' => 'Gerard',      'dateNaisPer' => '1919-04-29', 'bioPer' => 'Realisateur et scenariste comique francais.',   'lieuNaisPer' => 'Paris, France']);
        $pDeFunes     = Personne::create(['nomPer' => 'De Funes',    'prenomPer' => 'Louis',       'dateNaisPer' => '1914-07-31', 'bioPer' => 'Icone de la comedie francaise.',                'lieuNaisPer' => 'Courbevoie, France']);
        $pBourvil     = Personne::create(['nomPer' => 'Bourvil',     'prenomPer' => 'Andre',       'dateNaisPer' => '1917-07-27', 'bioPer' => 'Acteur et chanteur comique francais.',          'lieuNaisPer' => 'Pretot-Vicquemare, France']);
        $pNolan       = Personne::create(['nomPer' => 'Nolan',       'prenomPer' => 'Christopher', 'dateNaisPer' => '1970-07-30', 'bioPer' => 'Realisateur et scenariste britannique.',        'lieuNaisPer' => 'Londres, Angleterre']);
        ...
        $pPhillips    = Personne::create(['nomPer' => 'Phillips',    'prenomPer' => 'Todd',        'dateNaisPer' => '1970-12-20', 'bioPer' => 'Realisateur et scenariste americain.',          'lieuNaisPer' => 'New York, USA']);
        $pPhoenix     = Personne::create(['nomPer' => 'Phoenix',     'prenomPer' => 'Joaquin',     'dateNaisPer' => '1974-10-28', 'bioPer' => 'Acteur americain oscarise.',                    'lieuNaisPer' => 'San Juan, Porto Rico']);
        $pGerwig      = Personne::create(['nomPer' => 'Gerwig',      'prenomPer' => 'Greta',       'dateNaisPer' => '1983-08-04', 'bioPer' => 'Realisatrice et scenariste americaine.',        'lieuNaisPer' => 'Sacramento, USA']);
        $pVilleneuve  = Personne::create(['nomPer' => 'Villeneuve',  'prenomPer' => 'Denis',       'dateNaisPer' => '1967-10-03', 'bioPer' => 'Realisateur quebecois.',                        'lieuNaisPer' => 'Gentilly, Canada']);
        $pChalamet    = Personne::create(['nomPer' => 'Chalamet',    'prenomPer' => 'Timothee',    'dateNaisPer' => '1995-12-27', 'bioPer' => 'Acteur franco-americain.',                      'lieuNaisPer' => 'New York, USA']);
        $pMiyazaki    = Personne::create(['nomPer' => 'Miyazaki',    'prenomPer' => 'Hayao',       'dateNaisPer' => '1941-01-05', 'bioPer' => 'Maitre de l animation japonaise.',              'lieuNaisPer' => 'Tokyo, Japon']);
        ...
        $pBongJoonho  = Personne::create(['nomPer' => 'Bong',        'prenomPer' => 'Joon-ho',     'dateNaisPer' => '1969-09-14', 'bioPer' => 'Realisateur et scenariste sud-coreen oscarise.','lieuNaisPer' => 'Daegu, Coree du Sud']);
