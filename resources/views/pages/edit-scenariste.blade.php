...
<head>
    ...
    <title>Modifier un scénariste</title>
...
<main class="add-actor-page">
    <h1 class="add-actor-title">Modifier un scénariste</h1>

    <form class="add-actor-form" action="{{ route('scenariste.update', $scenaristes->idPer) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="add-film-content-grid">
            ...
            <!-- Colonne droite : infos scénariste -->
            <div class="add-film-side-col">
                ...
                <input
                    ...
                    name="dateNaisPer"
                    class="add-actor-input"
                    value="{{ \Carbon\Carbon::parse($scenaristes->dateNaisPer)->format('Y-m-d') }}"
                    required
                />
            </div>
        </div>
