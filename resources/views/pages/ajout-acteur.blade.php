...
<main class="add-actor-page">
    ...
    <form class="add-actor-form" action="{{ route('acteur.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <textarea name="bioPer" class="add-actor-textarea" placeholder="Biographie"></textarea>
